...
parser: $(INCLUDE_DIR)/parser.h $(LIB_DIR)/libuaparser.a $(LIB_DIR)/libpcre++.a $(LIB_DIR)/libyaml-cpp.a
	$(CC) $(SRC_DIR)/bootstrap.cpp -o parser -I$(INCLUDE_DIR) -L$(LIB_DIR) -luaparser $(LD_FLAGS)
